      ...
      <section id="mission" className="mx-auto mt-10 max-w-5xl px-6 pb-16 sm:mt-16">
        <div className="relative pt-40 sm:pt-52">
          <img
            ...
            alt=""
            aria-hidden="true"
            className="pointer-events-none absolute left-1/2 top-0 z-10 h-56 w-56 -translate-x-1/2 -translate-y-6 select-none object-contain object-bottom drop-shadow-xl sm:h-72 sm:w-72 sm:-translate-y-8"
          />
